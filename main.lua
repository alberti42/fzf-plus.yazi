...
function M:entry(job)
	...
	-- Only accept a string for --fzf-command; any other type is treated as an error.
...
function M.run_with(cwd, selected, default_cmd)
	...
	-- Override FZF_DEFAULT_COMMAND only when fzf is not fed via selection/stdin.
...
function M.parse_args(args)
	...
	-- Yazi normalizes --fzf-command to fzf_command.
	local v = args.fzf_command
